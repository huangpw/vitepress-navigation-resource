    ...
    items: [
      {
        ...
        icon: './icons/bootstrap-icons.png',
        title: 'Bootstrap Icons',
        desc: '免费，高质量，开源图标库超过2000个图标。',
      ...
      },
      {
        ...
        title: 'Icônes',
        desc: '汇集百个可商用图示集，支援SVG、IconFont及多种前端框架。',
        link: 'https://icones.js.org/',
        badge: 'All'
      },
      {
        icon: './icons/icons8.svg',
        title: 'Icons8',
        desc: '由我们的团队、设计软件和人工智能工具精心绘制的原创图片库。',
      ...
      {
        icon: './icons/iconscout.png',
        title: 'Iconscout',
        desc: '策划SVG，矢量图标，插图，3D图形和Lottie动画。每天新增资产超过10，000+。集成插件、工具、编辑器等。',
        link: 'https://iconscout.com/',
        badge: 'All'
      },
      {
        icon: './icons/iconfinder.png',
        title: 'Iconfinder',
        desc: '更快地制作精美的设计。',
      ...
      {
        icon: './icons/thenounproject.ico',
        title: 'The Noun Project',
        desc: '世界上最多样化和广泛的图标和任务驱动的照片集合。',
        link: 'https://thenounproject.com/',
        badge: 'All'
      },
      {
        icon: './icons/google-icons.svg',
        title: 'Google Fonts',
        desc: 'Google在线Icons集合。',
        link: 'https://fonts.google.com/icons',
        badge: 'All'
      },
      {
        icon: './icons/iconset.svg',
        title: 'Iconset',
        desc: '免费选择SVG图标，图标集和图标包的网络，移动的和打印项目的商业用途。',
        link: 'https://iconset.io/icons',
        badge: 'All'
      },
      {
        icon: './icons/eva-icons.ico',
        title: 'Eva Icons',
        desc: '一个包的480多个制作精美的开源图标的共同行动和项目。',
