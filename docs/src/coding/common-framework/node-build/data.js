    ...
    items: [
        {
            ...
            title: 'Webpack中文网',
            desc: '一个用于现代JavaScript应用程序的静态模块打包工具。',
        ...
        },
        {
            ...
            title: 'Rspack',
            desc: '基于 Rust 的高性能 Web 打包工具（使用兼容 API 无缝替换 webpack）。',
        ...
        },
        {
            ...
            title: 'Turbo',
            desc: 'Turbo是一个增量编译器和构建系统，针对JavaScript和TypeScript进行了优化，用Rust编写。',
            link: 'https://turbo.build/',
            badge: '官网'
        },
        {
            icon: './icons/babeljs.png',
            title: 'Babel',
