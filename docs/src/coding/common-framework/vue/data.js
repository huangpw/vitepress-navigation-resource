export const NAV_DATA = [
    {
        ...
        items: [
            ...
            {
                icon: 'https://vitejs.cn/vite3-cn/logo-with-shadow.png',
                title: 'Vite官网',
                desc: 'Vite是Vue3官方推荐的前端构建工具，以其快速的热更新和构建速度而闻名，极大提升了开发体验。',
            ...
            },
            {
                ...
                title: 'Vue Router V4',
                desc: 'Vue Router是Vue.js的官方路由管理器，它允许你构建单页面应用（SPA）。',
            ...
            },
            {
                icon: 'https://router.vuejs.org/logo.svg',
                title: 'Vue Router V3',
                desc: 'Vue Router V4是官方的路由管理器，专为Vue3设计。它提供了一种声明式的方式来定义导航和页面路由，使得构建单页面应用（SPA）变得更加容易。',
            ...
            },
            {
                ...
                title: 'Vue Devtools',
                desc: '一个旨在增强Vue开发人员体验的工具，它是一个功能强大的通用工具，可以显着提高您在使用Vue应用程序时的生产力和调试能力。',
            ...
            },
            {
                ...
                title: 'VitePress',
                desc: '一个以Markdown为中心的静态站点生成器 (SSG)，专为构建快速、以内容为中心的站点而设计。',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                desc: '一款Pinia数据持久化插件，可以用来对Store中的数据做本地持久化存储。',
            ...
            },
            {
                ...
                title: 'Prettier',
                desc: '一个支持多种编程语言和编辑器的代码格式化工具，可以按保存键时自动格式化代码，节省时间和精力。',
            ...
            },
            {
                ...
                desc: '自动导入Vite、Webpack、Rollup和esbuild的API。支持TypeScript。',
            ...
            },
            {
                ...
                title: 'Vue I18N',
                desc: 'Vue3的国际化插件。在做国际化I18N的时候可以借助vue-i18n这个包来完成，使用起来很方便。',
                link: 'https://kazupon.github.io/vue-i18n/zh/',
                badge: '国际化'
            },
            {
                icon: 'https://vue-macros.dev/logo.svg',
                title: 'Vue Macros',
                desc: '探索更多的宏和语法糖到Vue中。实现Vue尚未正式支持的功能提案或想法的库。',
            ...
            {
                icon: 'https://hu-snail.github.io/vue3-resource/logo.png',
                title: 'Vue3-Resource',
                desc: '收集优质Vue3资源库，包含web端&移动端&小程序&Electron等栏目。',
                link: 'https://hu-snail.github.io/vue3-resource/',
                badge: '资源'
            },
            {
                icon: 'https://github.com/vuejs/awesome-vue/raw/master/assets/logo.svg',
                title: 'Awesome Vue',
